                    ...
                    <div class="body">
                      <div class="content">
                        ...
                        <div class="info">
                          ...
                          <span class="office-location">
                            <a href="#">
                              <i data-feather="map-pin"></i>Washington
                            </a>
                          </span>
                    ...
                    <div class="body">
                      <div class="content">
                        ...
                        <div class="info">
                          ...
                          <span class="office-location">
                            <a href="#">
                              <i data-feather="map-pin"></i>Las Vegas
                            </a>
                          </span>
                          <span class="job-type temporary">
                            <a href="#">
              ...
              <div class="job-filter-wrapper">
                ...
                <div data-id="experience" class="job-filter experience same-pad">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#" data-attr="3 Year">3 Year</a>
                    </li>
                    <li>
                      <a href="#" data-attr="4 Year">4 Year</a>
                    </li>
                    <li>
                      <a href="#" data-attr="5 Year">5 Year</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Avobe 5 Years">Avobe 5 Years</a>
                    </li>
                  </ul>
                </div>
                ...
                <div data-id="post" class="job-filter post same-pad">
                  ...
                  <ul>
                    <li>
                      <a href="#" data-attr="Last hour">Last hour</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Last 24 hour">Last 24 hour</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Last 7 days">Last 7 days</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Last 14 days">Last 14 days</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Last 30 days">Last 30 days</a>
                    </li>
                  </ul>
                </div>
                <div data-id="gender" class="job-filter same-pad gender">
                  ...
                  <ul>
                    <li>
                      <a href="#" data-attr="Male">Male</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Female">Female</a>
                    </li>
                  </ul>
                </div>
                <div data-id="qualification" class="job-filter qualification same-pad">
                  ...
                  <ul>
                    <li>
                      <a href="#" data-attr="Matriculation">Matriculation</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Intermidiate">Intermidiate</a>
                    </li>
                    <li>
                      <a href="#" data-attr="Gradute">Gradute</a>
                    </li>
                  </ul>
                </div>
              </div>
