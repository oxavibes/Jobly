          ...
          <div class="testimonial">
            ...
            <div class="testimonial-nav">
              <div class="commenter-thumb">
                <img
                  src="../../public/assets/images/testimonial/thumb-1.jpg"
                  class="img-fluid commenter"
                  alt
                />
                <img
                  src="../../public/assets/images/testimonial/1.png"
                  class="comapnyLogo"
                  alt
                />
              </div>
              <div class="commenter-thumb">
                <img
                  src="../../public/assets/images/testimonial/thumb-2.jpg"
                  class="img-fluid commenter"
                  alt
                />
                <img
                  src="../../public/assets/images/testimonial/2.png"
                  class="comapnyLogo"
                  alt
                />
              </div>
              <div class="commenter-thumb">
                <img
                  src="../../public/assets/images/testimonial/thumb-3.jpg"
                  class="img-fluid commenter"
                  alt
                />
                <img
                  src="../../public/assets/images/testimonial/3.png"
                  class="comapnyLogo"
                  alt
                />
              </div>
              <div class="commenter-thumb">
                <img
                  src="../../public/assets/images/testimonial/thumb-4.jpg"
                  class="img-fluid commenter"
                  alt
                />
                <img
                  src="../../public/assets/images/testimonial/4.png"
                  class="comapnyLogo"
                  alt
                />
              </div>
              <div class="commenter-thumb">
                <img
                  src="../../public/assets/images/testimonial/thumb-5.jpg"
                  class="img-fluid commenter"
                  alt
                />
                <img
                  src="../../public/assets/images/testimonial/5.png"
                  class="comapnyLogo"
                  alt
                />
              </div>
